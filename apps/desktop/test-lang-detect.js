...
console.log('Detected language:', guessLanguage(testCode));

// Test individual regexes
console.log('console.log test:', /console\.log\(/.test(testCode));
console.log('function test:', /function\s+\w+\(/.test(testCode));
console.log('=> test:', /=>/.test(testCode));
